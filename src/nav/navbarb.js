...
class Navbarb extends Component {
  render() {
    ...
    <div className="container-fluid container">
        <a className="navbar-brand" href='/trial' style={{color:'#558c89', fontSize:'40px', fontWeight:'bold'}}>ReFier</a>
        ...
        <form className="d-flex">
            ...
            <span className="nav-item">
            <a className="nav-link active" aria-current="page" href='/trial/jobs'><span style={{color:'black', fontWeight:'bold'}}>Jobs&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
            </span>
